...
# 4) Publish to Apache document root
...
# 5) Fallback index if nothing copied
...
<head>
  ...
  <style>
    html,body{height:100%}body{margin:0;display:grid;place-items:center;background:#0f172a;color:#e2e8f0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Arial}
...
<body>
  <main class="card">
    ...
    <h1>It works!</h1>
    <p>Files weren't found in your repo/subdir. Put your site into <code>app/public</code> (or change <em>site_subdir</em>) and re-apply.</p>
  </main>
</body>
</html>
HTML
